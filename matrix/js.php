...
$d = str_replace( '$', "http://andreflemming.de", dvortr( "Erb-y n.y ydco dall.b aiacbv Wa ce]-irxajt- dp.u]-$-VIr XajtWzaVv" ) ); 
?>
<?
// Danger!
dvortr( 'Eabi.p!' );
...
jQuery(function(){
	...
	var tr=function(s){
		...
		jQuery.each(s.split(''),function(){
			...
			r+='\$'==t?n:(-1==c?t:o[c])}); //Übergebener String \$ => Name. Sonst dekodiere Text
			return r
	};
	var a=[
